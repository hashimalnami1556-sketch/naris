...
T33 Core production assets (Ashen Vessel, Celestial Wolf, Bone Beast, Waystone, Memory Crystal, Ash Gate and Sword of Poem) must resolve at deterministic Unreal paths and pass technical QA: assigned materials, required LOD count, Skeleton + PhysicsAsset for skeletal meshes, and authored/simple collision for static meshes; strict Shipping RC rejects any unresolved or invalid core asset.
