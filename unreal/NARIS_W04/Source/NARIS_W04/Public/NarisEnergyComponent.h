...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Energy")
    ENarisEssence ActiveEssence = ENarisEssence::NarisFlame;
    ...
    UFUNCTION(BlueprintCallable, Category="NARIS|Energy")
    void SetEssence(ENarisEssence NewEssence);

    UFUNCTION(BlueprintCallable, Category="NARIS|Energy")
    void CycleEssence(int32 Direction);

    UFUNCTION(BlueprintPure, Category="NARIS|Energy")
    FText GetActiveEssenceDisplayName() const;
};
