...
import { CharacterProfile, CharacterId } from '../../types/gameTypes';
  ...
  private getCharacterProfile(characterId: CharacterId): CharacterProfile {
    const profiles: Record<CharacterId, CharacterProfile> = {
      ash: {
        ...
        colorScheme: { primary: '#4d4d56', secondary: '#999999', accent: '#ff6b6b', energy: '#ffaa00' },
        scale: 1,
        speed: 6,
        baseHealth: 100,
        baseDamage: 15,
      ...
      rune: {
        ...
        colorScheme: { primary: '#4059b0', secondary: '#7a9fd0', accent: '#9d84ff', energy: '#00d4ff' },
        scale: 1,
        speed: 6.5,
        baseHealth: 75,
        baseDamage: 12,
      ...
      kor: {
        ...
        colorScheme: { primary: '#724628', secondary: '#a0693d', accent: '#ff6b35', energy: '#f7931e' },
        scale: 1.1,
        speed: 5,
        baseHealth: 120,
        baseDamage: 20,
